  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "smooth-bounce": "smooth-bounce 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55)",
      },
      backgroundImage: {
      ...
      boxShadow: {
        'mosque': '0 4px 20px rgba(5, 150, 105, 0.15)',
        'mosque-lg': '0 10px 40px rgba(5, 150, 105, 0.2)',
        'gold': '0 4px 20px rgba(234, 179, 8, 0.15)',
        'gold-lg': '0 10px 40px rgba(234, 179, 8, 0.2)',
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
