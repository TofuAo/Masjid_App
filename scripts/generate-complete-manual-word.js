...
async function generateCombinedDocs() {
  console.log('Generating combined documentation Word file...\n');
  ...
  const filename = `MyMasjidApp_Complete_Documentation_${timestamp}.docx`;
  ...
  try {
    ...
    console.log(`\n[SUCCESS] Combined documentation generated: ${filename}`);
