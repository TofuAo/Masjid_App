#!/usr/bin/env python3
"""
Script to convert INDUSTRIAL_TRAINING_REPORT.md to Word document with exact format matching the example
- Thin black border around content
- Single spacing
...
def add_formatted_paragraph(doc, text, font_name='Times New Roman', font_size=12, bold=False, alignment=None):
    """Add a formatted paragraph to the document with single spacing"""
    p = doc.add_paragraph()
    if alignment:
    ...
    p_format.line_spacing = 1.0  # Single spacing
...
def create_word_document():
    """Create Word document from markdown file with exact format"""
    # Read markdown file
    ...
    # Save document
    output_file = 'INDUSTRIAL_TRAINING_REPORT_FORMATTED.docx'
    ...
    print("  ✓ Proper margins (2.5cm/2.5cm/3.0cm/2.5cm)")
    ...
    print("  4. Add supervisor name and date")
