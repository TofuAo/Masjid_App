 ...
 * Creates animated spark effects when clicking on wrapped content
 * 
 * @param {string} sparkColor - Color of the sparks (default: '#fff')
 * @param {number} sparkSize - Size of each spark line (default: 10)
 * @param {number} sparkRadius - Radius of the spark spread (default: 15)
 ...
 * @param {ReactNode} children - Content to wrap with spark effect
 */
const ClickSpark = ({
  sparkColor = '#fff',
  sparkSize = 10,
